...
\filepath{src/prefix_cache_evolve/problems/prefix_kv_cache/production_incumbent.py} &
Current promoted deployable policy discovered by the production-oriented search. \\
\filepath{src/prefix_cache_evolve/problems/prefix_kv_cache/pressure_aware_incumbent.py} &
Historical discovery policy used for the reproducible \(77.113\) hardened-accounting
result, originally reported as \(77.230\). \\
