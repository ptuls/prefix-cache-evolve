...
\(63.548\).  It also passes the held-out agentic tripwire, scores \(3.064\) on the
hidden panel versus \(-2.789\) for TinyLFU-LRU, and retains substantially lower churn.
...
ahead of TinyLFU-LRU at \(63.548\).  It passes the held-out agentic tripwire with a
\(0.0918\) surrogate-to-probe gap, scores \(3.064\) on the hidden panel versus
